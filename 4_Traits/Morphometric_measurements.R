...
setwd("D:/Doctorado/Tesis/traits")
#
# packages
library(readxl)
library(dplyr)
...
# dataset new photos morphometrics
  data_new <- read_excel("C:/Users/Dell-PC/Dropbox/CO_DBdata/template_sheet_morph_traits_2024.xlsx", sheet="Sheet1")
...
# merge by individual_id_number y scientificName
  means_new <- merge(mean_body_elytra, mean_legs, 
                     by = c("scientificName", "individual_id_number"))
#
# dataset 2021 morphometrics
  data_2021 <- read_excel("C:/Users/Dell-PC/Dropbox/CO_DBdata/output_allmorphmetrics_withsppnames_2024.xlsx", sheet = "output_allmorphmetrics_withsppn")
#
...
# Merge morphometrics measurements and behaviour traits in Dung beetles data set
 DB_data <- read_excel("C:/Users/Dell-PC/Dropbox/CO_DBdata/Scarabaeinae_database_2024.xlsx", sheet="Scarabaeinae_database_2024")
 behaviour <- read_excel("C:/Users/Dell-PC/Dropbox/CO_DBdata/DB_Distributions_traits_2024.xlsx", sheet="DB_Distributions_traits")
