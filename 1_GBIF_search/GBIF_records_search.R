# ------------------------------------------------------------------------------
# This script processes a dung beetle (Scarabaeinae) dataset to generate 
# occurrence records used in the Supplementary Materials (SOM). It extracts 
# species and subspecies names from the abundance dataset, retrieves known 
# synonyms from the GBIF Backbone Taxonomy to ensure inclusion of historical 
# names used in recent taxonomic revisions, and compiles a consolidated list 
# of all taxa.
#
# Based on this list, the script queries GBIF using the "rgbif" package (up to 
# 15,000 records per species) and filters for records with geographic coordinates. 
# The retrieved data are cleaned, updated to accepted taxonomy, duplicates removed, 
# and structured according to the Darwin Core standard.
#
# The resulting dataset provides the most comprehensive set of occurrence records 
# for all species and subspecies, and is used to construct geographic range maps.
# ------------------------------------------------------------------------------
...
# Dung beetles Dataset #
    IBDdata <- read_excel("C:/Users/PC/Dropbox/CO_DBdata/abundance/Scarabaeinae_database_2024.xlsx", 
                          sheet="Scarabaeinae_database_2024")
#
