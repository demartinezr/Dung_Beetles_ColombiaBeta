# ------------------------------------------------------------------------------
# Dung beetle unified dataset for Bayesian modeling
#
# This script compiles and processes all datasets required for the hierarchical
# Bayesian analysis of dung beetle abundance across Colombia.
#
# The workflow integrates multiple data sources including:
#   • field abundance records from several sampling projects
#   • sampling point metadata and environmental variables
#   • species geographical ranges
#   • biogeographic information
#   • functional trait data
#
# The script performs several key steps:
#   1. Cleans and harmonizes raw abundance data.
#   2. Implements a zero-filling procedure to create all species–point–day combinations.
#   3. Adds spatial information for sampling points (region, slope, elevation).
#   4. Integrates species biogeographic distributions.
#   5. Identifies feasible species–site combinations based on species range maps.
#   6. Computes standardized elevation and distance to species range boundaries.
#   7. Merges functional trait data.
#   8. Aggregates abundance data and filters the dataset for analysis.
#
# The resulting dataset is the final input used in the Bayesian hierarchical
# model of dung beetle abundance described in the main manuscript.
# ------------------------------------------------------------------------------
...
library(ggplot2)
# ------------------------------------------------------------------------------
# Load and clean abundance dataset
#
# Import the dung beetle abundance database and standardize variable names
#
...
# Zero-fill 
#      
# Create all possible species × point × day combinations.
# Missing combinations are assigned abundance = 0 to represent
# non-detections during sampling events.
#
# This step ensures that the dataset contains explicit absences,
# which are required for the hierarchical abundance model.
...
# Merge abundance data with sampling point information, including
# habitat, elevation, and spatial clustering variables.
...
# ------------------------------------------------------------------------------      
# Species biogeographic distributions 
#
# Format species regional and slope distributions used to constrain
# feasible species–site combinations.
  ...
  ##### Check biogeography #####
    ...
    #
# ------------------------------------------------------------------------------  
# Species–site feasible combinations
#
# Identify whether each sampling point falls within the geographic
# range of each species based on range polygons.
#
# combinations = 1 → point located within the species range
# combinations = 0 → point outside the species range
